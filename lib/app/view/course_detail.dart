...
class _CourseDetailScreenState extends State<CourseDetailScreen> {
  ...
  void onNaviInstructor(value) {
    ...
    Get.toNamed(AppRouter.intructorDetail, arguments: [instructor]);
  }
  ...
  Widget renderItemRating(value) {
    ...
    return Column(children: [
      ...
      if (value.review["reviews"]["reviews"].isNotEmpty&&value.review["reviews"]["paged"] < value.review["reviews"]['pages'])
        InkWell(
          onTap: () {
            Get.toNamed(AppRouter.review, arguments: [value.courseId]);
          },
          child: Container(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                _buildShimmerBox(120, 24, borderRadius: 8),
                const Spacer(),
          ...
          Padding(
            ...
            child: _buildShimmerBox(screenWidth - 32, (250 / 375) * screenWidth, borderRadius: 16),
          ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    _buildShimmerBox(40, 16, borderRadius: 4),
                  ],
                ),
                _buildShimmerBox(80, 20, borderRadius: 4),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildShimmerBox(screenWidth - 32, 14, borderRadius: 4),
                const SizedBox(height: 8),
                _buildShimmerBox(screenWidth - 80, 14, borderRadius: 4),
                const SizedBox(height: 8),
                _buildShimmerBox(screenWidth - 120, 14, borderRadius: 4),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildShimmerBox(screenWidth - 32, 50, borderRadius: 8),
                const SizedBox(height: 12),
                _buildShimmerBox(screenWidth - 32, 50, borderRadius: 8),
                const SizedBox(height: 12),
                _buildShimmerBox(screenWidth - 32, 50, borderRadius: 8),
  ...
  /// Shimmer Box with Static Gradient (simple, performant)
